...
def main():
    ...
    # 识别指定文件目录下的图片
    # 图片存放目录figures
    dir = 'D://work//parttime//191203咸鱼//test'

    # correct_count = 0  # 图片总数
    total_count = 0    # 识别正确的图片数量
    dat = pd.DataFrame(columns=['index','target'])
    i = 0
    ...
    for file in os.listdir(dir):
        if file.endswith('.jpg'):
            ...
            total_count += 1
            dat.loc[i,'index'] = i
            dat.loc[i,'target'] = recognizition
            print(i)
            i = i+1
...
main()
dat.to_csv('D://work//parttime//191203咸鱼//test_target.csv', index = False)
OCR_lmj('D://work/parttime/191203咸鱼/data/0a5Jz.jpg')